...
public:
    ...
    void setupUi(QWidget *ProbeCalibrationWidget)
    {
        ...
        saveButton = new QPushButton(ProbeCalibrationWidget);
        ...
        QObject::connect(saveButton, SIGNAL(clicked()), ProbeCalibrationWidget, SLOT(saveCalibration()));
    ...
    void retranslateUi(QWidget *ProbeCalibrationWidget)
    {
        ...
        saveButton->setText(QApplication::translate("ProbeCalibrationWidget", "Save Calibration", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
